...
importSTARLog <- function(dir, recursive = TRUE, verbose = TRUE){
...
out <- importSTARLog(dir="/media/ejo138/Fantec5/Projects/RumenPredict/ReinCowPapillae/BAM/Cow/ARS-UCD12/")
